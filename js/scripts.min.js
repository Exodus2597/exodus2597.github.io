  ...
  function e() {
    ...
    (txtString = $(this).text()),
	  ...
	  txtString.toLowerCase().indexOf(" says:") >= 0 && $(this).addClass("white"),
		...
		txtString.toLowerCase().indexOf(" (car)") >= 0 && txtString.toLowerCase().indexOf(" whispers:") >= 0 && $(this).addClass("carwhisper"),
		txtString.toLowerCase().indexOf(" (car)") >= 0 && $(this).addClass("megafon"),
